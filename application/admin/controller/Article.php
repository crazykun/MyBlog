...
class Article extends AdminBase
{
    ...
    {
        $starttime=Request::instance()->get('starttime');
        $endtime=Request::instance()->get('endtime');
        ...
        $article_list  = $this->article_model->field($field)->where($map)->order(['publish_time' => 'DESC'])->paginate(15, false,['query'=>$param]);
